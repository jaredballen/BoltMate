...
namespace LogiPlusSwitcher.Core.Autostart;
...
public static class AutostartManager
{
    ...
    /// Label and the schtasks /tn name. e.g. com.jaredballen.logiplusswitcher
    /// (CLI) vs com.jaredballen.logiplusswitcher.app (App).</param>
