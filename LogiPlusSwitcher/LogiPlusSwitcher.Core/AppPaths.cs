...
{
    public const string AppFolderName = "LogiPlusSwitcher";

    /// <summary>User-readable settings (JSON config). macOS: <c>~/Library/Application Support/LogiPlusSwitcher</c>.</summary>
    ...
    /// <summary>Logs directory. macOS: <c>~/Library/Logs/LogiPlusSwitcher</c>.</summary>
